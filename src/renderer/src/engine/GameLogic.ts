...
export class GameLogic {
  ...
  OnContactAdded = (
    ...
    //   settings
    // )
    // NEED TO FILTER OUT VirtualCharacter bodies created alongside them, perhaps with a special Filter (unless only compares against the characters already)
