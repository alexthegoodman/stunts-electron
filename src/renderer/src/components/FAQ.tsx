...
const FAQ = ({ language = 'en' }) => {
      ...
      copy = {
        ...
        faqs: [
          ...
          },
          {
            ...
            answer: 'The editor supports HD MP4 export only for now, but 4K export is coming soon.'
          },
          {
    ...
    case 'hi':
      copy = {
        ...
        faqs: [
          ...
          {
            question: 'क्या जेनरेटिव कीफ्रेम्स परफेक्ट रूप से out of the box काम करते हैं?',
            answer:
  ...
  return (
    <div className="bg-slate-900 text-slate-200 py-12 px-6">
      <h1 className="text-4xl font-bold text-red-500 mb-8 text-center">{copy?.title}</h1>
      <div className="max-w-4xl mx-auto space-y-6">
        {copy?.faqs.map((faq, index) => (
          <div key={index} className="p-6 bg-slate-800 rounded-md shadow-md">
            <h2 className="text-2xl font-semibold text-red-400">{faq.question}</h2>
