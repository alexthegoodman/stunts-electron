...
export default function Project() {
  ...
  const [hubAlertVisible, setHubAlertVisible] = useLocalStorage<boolean>('hub-alert-visible', true)
            ...
            {hubAlertVisible && (
              <section className="bg-yellow-100 text-yellow-800 p-4 rounded-lg mb-6 w-full md:w-[600px]">
                <div className="flex justify-between items-center mb-2">
                  <h2 className="text-lg font-semibold">{t('Welcome to the Hub')}!</h2>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">{t('Here you can generate content...')}</span>
                </div>
              </section>
            )}

            <h1 className="text-3xl text-center mb-12">{t('Welcome to the Hub')}</h1>
            <FlowSteps step={1} />
            <div className="flex flex-col p-1 md:p-0 w-full">
              ...
              <div className="flex flex-col justify-center items-center mx-auto w-full md:w-[600px] rounded-[15px] shadow-[0_0_15px_4px_rgba(0,0,0,0.16)]">
                <textarea
                  ...
                  placeholder={t('You must enter a prompt / description to begin') + '...'}
